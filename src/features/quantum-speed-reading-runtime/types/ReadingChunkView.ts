...
// Mode™ Sprint-1's shared-extraction. The real shape now lives in the
...
// unchanged.
export type { ModeChunkView as ReadingChunkView } from '@/features/learning-mode-runtime/types/ModeChunkView'
