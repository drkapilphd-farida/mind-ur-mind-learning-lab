...
// since loading a ULO was already fully mode-agnostic. This re-export
// preserves QSR's own name and import path exactly.
export { loadUniversalLearningObject } from '@/features/learning-mode-runtime/persistence/loadUniversalLearningObject'
