...
import type { GuidedParagraphReadingModeQuizQuestion } from '../guidedParagraphReadingModeDataset'

// Same literal high-contrast palette as GuidedParagraphReadingModeCanvas.tsx
// / Vertical Chunk Sliding's own quiz (own-copy, not a shared import).
...
type GuidedParagraphReadingModeQuizProps = {
...
// ParagraphReadingModeQuiz.tsx's exact pattern, appears once the guided
// reading session finishes, before the standard ReadingSessionCompleteScreen
// (this mode's "performance summary"). A single, ungated pass — every
// question gets answered once, the score is shown, and Continue always
// moves forward — replacing this mode's old per-passage pass/retry
// ComprehensionCheckpoint gate entirely.
export function GuidedParagraphReadingModeQuiz({ questions, categoryLabel, onComplete, onExit }: GuidedParagraphReadingModeQuizProps): React.JSX.Element {
      ...
      <div className="flex w-full flex-col items-center gap-6">
        <div className="w-full text-center">
          ...
          <p className="text-xs text-muted-foreground">
            Passage: {categoryLabel} · Question {questionIndex + 1} of {totalQuestions}
          </p>
        </div>
