// Best-stats store for Color & Scene Transformation Journey™ — a small,
...
export type ColorSceneTransformationBestStats = {
  bestAccuracyPercent: number
  bestStreak: number
}

const EMPTY_BEST: ColorSceneTransformationBestStats = { bestAccuracyPercent: 0, bestStreak: 0 }

export function loadBestColorSceneTransformationStats(storageKey: string): ColorSceneTransformationBestStats {
...
export function recordBestColorSceneTransformationStats(
  storageKey: string,
  session: ColorSceneTransformationBestStats,
): ColorSceneTransformationBestStats {
  const previous = loadBestColorSceneTransformationStats(storageKey)
  const next: ColorSceneTransformationBestStats = {
