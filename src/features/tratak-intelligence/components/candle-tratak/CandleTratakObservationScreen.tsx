...
type CandleTratakObservationScreenProps = {
...
// Mirrors ObservationIntelligenceScreen.tsx / ImagePersistenceObservationScreen.tsx's
// exact pattern for the one fixed Candle Tratak™ image.
export function CandleTratakObservationScreen({ onContinue, isSubmitting = false }: CandleTratakObservationScreenProps): React.JSX.Element {
