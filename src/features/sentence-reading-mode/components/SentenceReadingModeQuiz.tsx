...
import type { SentenceReadingModeQuizQuestion } from '../sentenceReadingModeDataset'

// Same literal high-contrast palette as SentenceReadingModeCanvas.tsx /
// Vertical Chunk Sliding's own quiz (own-copy, not a shared import — see
// those files' own comments on why these are static literal Tailwind
// classes).
...
type SentenceReadingModeQuizProps = {
...
// Post-exercise MCQ comprehension quiz — own-copy of
// VerticalChunkSlidingQuiz.tsx's exact pattern, appears once the sentence
// passage finishes, before the standard ReadingSessionCompleteScreen.
...
// locked useReadingRuntime.ts, and deliberately NOT the shared,
// pass/retry-gated ComprehensionCheckpoint.tsx this mode used before this
// overhaul — that component re-gates a level and can block continuing
// until a threshold is met, which is exactly the "early pop-up" /
// mid-stream interruption this overhaul removes. This quiz is a single,
// ungated pass: every question gets answered once, the score is shown,
// and Continue always moves forward.
export function SentenceReadingModeQuiz({ questions, categoryLabel, onComplete, onExit }: SentenceReadingModeQuizProps): React.JSX.Element {
