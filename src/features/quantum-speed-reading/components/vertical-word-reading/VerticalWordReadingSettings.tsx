...
export function VerticalWordReadingSettings({ targetWpm, onSelectTargetWpm, onStart }: VerticalWordReadingSettingsProps): React.JSX.Element {
  return (
    <div className="relative mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center gap-10 px-6 py-16 text-center">
      ...
      <div>
        <h1 className="font-heading text-2xl font-bold tracking-tight text-foreground">Vertical Word Reading™</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          A calm, continuous column of words. Read down the list at your own pace — no flashing, no jumping.
        </p>
      </div>
