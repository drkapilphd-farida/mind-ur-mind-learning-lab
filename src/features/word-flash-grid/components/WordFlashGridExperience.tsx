...
export function WordFlashGridExperience({ onComplete }: WordFlashGridExperienceProps = {}): React.JSX.Element {
  const curriculumSession = useCurriculumSessionCompletion('word-flash-grid', LAB_HREF)
  ...
  function handleExitRequested(elapsedMs: number): void {
    ...
    router.push(getCurriculumSmartExitHref('word-flash-grid', LAB_HREF))
  }
    ...
    return (
      <>
        <WordFlashGridCompleteScreen
          backHref={getWizardAwareBackHref('word-flash-grid', LAB_HREF)}
