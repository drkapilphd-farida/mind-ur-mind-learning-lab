...
// real paywall: hasQuantumSpeedReadingProAccess() (a real subscription
// row required, no free-access window — see getIsPaidUser.ts), reused
// rather than duplicated so this stays in sync with every other paid
// gate in the app.
