...
import type { ParagraphReadingModeQuizQuestion } from '../paragraphReadingModeDataset'

// Same literal high-contrast palette as ParagraphReadingModeCanvas.tsx /
...
type ParagraphReadingModeQuizProps = {
...
// VerticalChunkSlidingQuiz.tsx / SentenceReadingModeQuiz.tsx's exact
// pattern, appears once the paragraph stream finishes, before the standard
// ReadingSessionCompleteScreen (this mode's "session recap"). A single,
// ungated pass — every question gets answered once, the score is shown,
// and Continue always moves forward — replacing this mode's old per-
// passage pass/retry ComprehensionCheckpoint gate entirely.
export function ParagraphReadingModeQuiz({ questions, categoryLabel, onComplete, onExit }: ParagraphReadingModeQuizProps): React.JSX.Element {
