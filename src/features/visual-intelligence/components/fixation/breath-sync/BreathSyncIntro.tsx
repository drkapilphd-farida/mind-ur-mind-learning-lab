...
type BreathSyncIntroProps = {
  onStart: () => void
}

export function BreathSyncIntro({ onStart }: BreathSyncIntroProps): React.JSX.Element {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col items-center gap-8 text-center">
      ...
      <div>
        ...
        <h1 className="mt-2 font-heading text-3xl font-bold tracking-tight text-foreground">Breath Sync™</h1>
        <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-muted-foreground">
          Follow the dot as it expands and contracts with your breath.
        </p>
      </div>
