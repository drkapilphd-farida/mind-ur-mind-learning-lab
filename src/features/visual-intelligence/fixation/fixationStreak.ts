...
// (src/lib/exercises/practiceHistory.ts) against this lab's own session
// shape — a small local copy, not a direct import, since that function is
// typed against PracticeSessionRecord/LabId, which this lab intentionally
// doesn't register in (fixation_sessions is a fully independent table).
...
export type FixationStreakSession = { occurredAt: string; completed: boolean }

export type FixationStreak = {
...
export function computeFixationStreak(
  sessions: readonly FixationStreakSession[],
