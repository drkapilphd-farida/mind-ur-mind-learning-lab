...
export function NumberFlashGridExperience({ onComplete }: NumberFlashGridExperienceProps = {}): React.JSX.Element {
  const curriculumSession = useCurriculumSessionCompletion('number-flash-grid', LAB_HREF)
  ...
  function handleExitRequested(elapsedMs: number): void {
    ...
    router.push(getCurriculumSmartExitHref('number-flash-grid', LAB_HREF))
  }
    ...
    return (
      <>
        <NumberFlashGridCompleteScreen
          backHref={getWizardAwareBackHref('number-flash-grid', LAB_HREF)}
