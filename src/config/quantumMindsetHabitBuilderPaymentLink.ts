// Quantum Mindset & Habit Builder™ (the 21-day program) — the real,
// hosted Razorpay Payment Link for its one-time upgrade. A single source
// of truth so the Day 8+ server redirect and the dashboard card's own
// locked-day/Upgrade CTAs never risk drifting to two different URLs.
