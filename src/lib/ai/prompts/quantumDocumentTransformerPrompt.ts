...
The user message specifies the target language and target question count for this request — read those values from there, not from this instruction block. Write every field entirely in the target language — ai_summary, spider_notes labels, keywords, quiz_questions, feynman_challenge, mnemonics, and subject_lens all in that language, regardless of what language the source document is written in. Do not mix in English unless the target language itself is English.
