...
export function buildQuantumDocumentTransformerPrompt(documentTitle: string, documentText: string, targetLanguage: SupportedLanguage): string {
...
- quiz_questions: 2-3 short active-recall questions a learner could quiz themselves with, each with its own answer. Questions should test recall of specific facts/ideas in the document, not vague generalities.
