...
export default function ResidentialFinalCta(): React.JSX.Element {
  const { t } = useLanguage();
  const section = t.residentialLanding.finalCta;
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-9 flex justify-center">
          <a
            ...
            onClick={() => trackGaEvent("whatsapp_click", { location: "residential_final_cta" })}
