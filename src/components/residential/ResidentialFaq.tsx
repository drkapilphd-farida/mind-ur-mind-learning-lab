...
export default function ResidentialFaq(): React.JSX.Element {
  const { t } = useLanguage();
  const section = t.residentialLanding.faq;
      ...
      <div className="mx-auto max-w-content">
        ...
        <div className="mx-auto mt-10 flex max-w-3xl justify-center">
          <a
            ...
            onClick={() => trackGaEvent("whatsapp_click", { location: "residential_faq" })}
