...
export default function HabitBuilderFaq(): React.JSX.Element {
  const { t } = useLanguage();
  const section = t.habitBuilderLanding.faq;
    ...
    <section id="faq" className="border-b border-line px-6 py-24 sm:px-8">
      <div className="mx-auto max-w-content">
        ...
        <div className="mx-auto mt-10 flex max-w-3xl justify-center">
          <a
            href={WHATSAPP_HABIT_BUILDER_INQUIRY_LINK}
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackGaEvent("whatsapp_click", { location: "habit_builder_faq" })}
