...
// Same scroll-reveal pattern as ResidentialStickyBar.tsx/QsrStickyBar.tsx.
const SCROLL_REVEAL_THRESHOLD_PX = 560;

export default function PrefrontalPowerStickyBar(): React.JSX.Element {
    ...
    >
      <div className="mx-auto flex max-w-content items-center justify-between gap-4 px-6 py-3.5 pb-[max(0.875rem,env(safe-area-inset-bottom))] sm:px-8">
        <div className="min-w-0">
          <p className="truncate text-[13.5px] font-semibold text-ink">PREfrontal POWER · 27 Sept, Mumbai</p>
          <p className="font-mono text-[11px] uppercase tracking-[0.06em] text-ink-faint">₹3,500 · 40 seats</p>
        </div>
        <a
          href={PREFRONTAL_POWER_REGISTRATION_URL}
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => trackGaEvent("whatsapp_click", { location: "prefrontal_power_sticky_bar" })}
