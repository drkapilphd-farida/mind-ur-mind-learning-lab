...
// FIX-01 — "Users should always know where they are in the journey."
// Modeled on Memory Discovery's own identical `MissionProgressDots`,
// duplicated here rather than imported — each Discovery module owns its
// own component tree.
